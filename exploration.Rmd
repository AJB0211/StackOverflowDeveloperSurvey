...
df18 <- s18 %>% mutate(Student = case_when(grepl("^N",   Student) ~ "no",
                ...
                select(Country, Student, Education, Undergrad, Employment, YearsCoding, YearsCodingProf, 
                       ...
                       DevType, LanguageWorkedWith, PlatformWorkedWith, DatabaseWorkedWith, FrameworkWorkedWith,
                       Salary, CurrencySymbol, ConvertedSalary, SalaryType, 
...
# Ambiguous whether salary is adjusted to USD
