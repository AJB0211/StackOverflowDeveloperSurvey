...
df18 <- s18 %>% mutate(Student = case_when(grepl("^N",   Student) ~ "no",
                ...
                select(Country, Student, Education, Undergrad, Employment, YearsCoding, YearsCodingProf, JobYear,
                       JobSearchStatus,TimeAfterBootcamp,
                       DevType, LanguageWorkedWith,LanguageDesireNextYear, 
                       PlatformWorkedWith, DatabaseWorkedWith, FrameworkWorkedWith,
                       Salary, CurrencySymbol, ConvertedSalary, SalaryType, Age, EducationParents, Sex)
...
df17 <- s17 %>% mutate(
  ...
  select(Country, Student, Education, Undergrad, Employment, YearsCoding, YearsCodingProf)
